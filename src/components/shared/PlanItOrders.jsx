...
const PlanItOrders = ({ orders, homeZone, selectedDate, onRefresh }) => {
  ...
  const refreshInterval = 30000; // 30 sekund
  ...
  useEffect(() => {
    if (autoRefresh && typeof onRefresh === 'function') {
    ...
    <div className="card planit-section">
      <div className="planit-section-header">
        ...
        <div className="flex items-center gap-4" style={{ marginLeft: 'auto' }}>
          ...
          {/* 🔄 AUTO REFRESH UI */}
          <div className="auto-refresh-controls" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
